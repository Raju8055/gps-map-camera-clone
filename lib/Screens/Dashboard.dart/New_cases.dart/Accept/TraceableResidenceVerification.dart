...
class TraceableScreenResidenceVerification extends StatefulWidget {
  const TraceableScreenResidenceVerification({super.key});
...
class _TraceableScreenState extends State<TraceableScreenResidenceVerification> {
  int _activeStep = 0;
  ...
  return [
    Form(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildQuestionText('1. Entry Allowed?'),
          _buildDropdownField(
            hint: 'Select options',
            value: entryAllowed,
            items: entryAlloweds,
          ...
          _buildQuestionText('2. What is the Name of the Person Met?'),
          _buildTextField(
          ...
          const SizedBox(height: 20),
          _buildQuestionText('3. Select Relationship'),
          _buildDropdownField(
            hint: 'Select options',
          ...
          const SizedBox(height: 20),
          _buildQuestionText('4. What is Applicant Age?'),
          _buildTextField(
          ...
          _buildQuestionText('5. Rented/Owned/Leased?'),
          _buildDropdownField(
            hint: 'Select options',
          ...
          const SizedBox(height: 20),
          _buildQuestionText('6. Years of Staying'),
          _buildTextField(
          ...
          const SizedBox(height: 20),
          _buildQuestionText('7. Total Family Members'),
          _buildTextField(
          ...
          const SizedBox(height: 20),
          _buildQuestionText('8. Number of Earning Members'),
          _buildTextField(
          ...
          const SizedBox(height: 20),
          _buildQuestionText('9. Number of Dependents'),
          _buildTextField(
          ...
          const SizedBox(height: 20),
          _buildQuestionText('10. Applicant working company'),
          _buildTextField(
          ...
          const SizedBox(height: 20),
          _buildQuestionText('11. Applicant designation'),
          _buildTextField(
          ...
          const SizedBox(height: 20),
          _buildQuestionText('12. Applicant Salary'),
          _buildTextField(
          ...
          const SizedBox(height: 20),
          _buildQuestionText('13. RCC/TILED/SHEET/HUT'),
          _buildDropdownField(
            hint: 'Select Type',
          ...
          const SizedBox(height: 20),
          _buildQuestionText('14. Independent/Part of Independent/Attached'),
          _buildDropdownField(
            hint: 'Select Type',
            value: selectedPropertyType,
            items: ['Independent', 'Part of Independent', 'Attached'],
            focusNode: roofTypeFocusNode,
            onChanged: (value) {
              setState(() {
                selectedPropertyType = value;
              });
              FocusScope.of(context).requestFocus(squareFeetFocusNode);
            },
            validator: (value) {
              if (value == null || value.isEmpty) {
                return 'Please select an option';
          ...
          const SizedBox(height: 20),
          _buildQuestionText('15. Square Feet'),
           _buildTextField(
            controller: squareFeetController,
            focusNode: squareFeetFocusNode,
            labelText: 'Enter Square Feet',
            keyboardType: TextInputType.number,
            onFieldSubmitted: (value) {
              FocusScope.of(context).requestFocus(areaTypeFocusNode);
            },
            validator: (value) {
              if (value == null || value.isEmpty) {
          ...
          const SizedBox(height: 20),
          _buildQuestionText('16. Type of Area'),
          _buildDropdownField(
            hint: 'Select Area Type',
            value: selectedAreaType,
            items: ['Middle class area', 'Commercial area', 'Industrial area', 'Village area'],
            focusNode: areaTypeFocusNode,
            onChanged: (value) {
              setState(() {
                selectedAreaType = value;
              });
              FocusScope.of(context).requestFocus(neighbourNameFocusNode);
            },
            validator: (value) {
              if (value == null || value.isEmpty) {
          ...
          const SizedBox(height: 20),
          _buildQuestionText('17. Neighbour Name'),
          _buildTextField(
            controller: neighbourNameController,
            focusNode: neighbourNameFocusNode,
            labelText: 'Enter Neighbour Name',
            keyboardType: TextInputType.name,
            onFieldSubmitted: (value) {
              FocusScope.of(context).requestFocus(kilometerFocusNode);
            },
            validator: (value) {
              if (value == null || value.isEmpty) {
                return 'Please enter neighbour name';
              }
              return null;
            },
          ),
          const SizedBox(height: 20),
          _buildQuestionText('18. Kilometer'),
          _buildTextField(
